    ...
    <main className="wrap">
      <header className="top">
        <a className="brand" href="#inicio" aria-label="Ir al inicio">
          ...
          <span className="tag">Artista autodidacta</span>
        </a>
        <nav className="nav" aria-label="Navegacion principal">
          <a className="pill" href="#galeria">
            Galeria
          </a>
          <a className="pill" href="#proceso">
            Proceso
          </a>
          <a
      ...
      <section id="inicio" className="hero">
        <div className="heroCard hero-copy">
          ...
          <h1>Retratos y animales dibujados con distintas técnicas</h1>
          <p className="lead">
            Soy <strong>ppm._.art</strong>. Trabajo cada encargo desde una
            referencia clara hasta una pieza con textura, contraste y detalle.
          </p>
          <div className="cta">
          ...
          <div className="stats" aria-label="Resumen del portafolio">
            <span>
              <strong>{obras.length}</strong> obras en galeria
            </span>
            <span>
              <strong>Lapiz</strong> detalle sobre papel
            </span>
            <span>
              <strong>DM</strong> encargos abiertos
            </span>
          </div>
        </div>
      ...
      <section id="galeria" className="section">
        <div className="sectionHead">
          <div>
            ...
            <p>
              Abre cualquier dibujo para verlo sin distracciones y revisar el
              detalle.
            </p>
          </div>
          <a className="text-link" href={IG} target="_blank" rel="noreferrer">
      ...
      <section id="proceso" className="section split">
        <div>
          ...
          <p className="lead compact">
            Enviame una foto con buena luz, dime el tamano que quieres y te
            respondo con precio, plazo y detalles.
          </p>
        </div>
        <div className="boxes">
          <div className="box">
          ...
          <div className="box">
            ...
            <p>Recibes avances y el dibujo final.</p>
          </div>
        </div>
      </section>
      ...
      <section className="final-cta">
        ...
        <h2>
          Si tienes una foto especial, puede convertirse en una pieza lenta y
          cuidada.
        </h2>
        <a className="btn" href={IG} target="_blank" rel="noreferrer">
          Abrir Instagram
      ...
      <a className="fab" href={IG} target="_blank" rel="noreferrer">
        Seguir @ppm._.art
      </a>
